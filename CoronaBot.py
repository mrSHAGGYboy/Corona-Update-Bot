...
APP_ID=6914958 #my.telegram.org
APP_HASH='67a74766ba6d9183d57a9dd51b85a8f3' #my.telegram.org
BOTT='1917032694:AAHpzNHosq_l65xxuKNfPUS6AfmHHWJzk30'#@botfather
...
def staat(qq):
  ...
  data = {
    "chat_id": str(qq),
    "photo": "https://telegra.ph/file/29578f9cd7129ff2c48df.jpg",
    "caption": "ශ්‍රී ලංකාවේ කොරෝනා තතු එසැනින් දැනගන්න. @sl_corona_update_bot Group එකට Add කරගත් පසු ස්වයංක්‍රියව නවතම කොරෝනා තතු ලබාගත හැක.  වැඩි විස්තර සදහා /help භාවිතා කරන්න.     ~ https://t.me/SL_MEDIA_TECH_GRUOP",
    "parse_mode": "HTML",
    "reply_markup": {
        "inline_keyboard": [
            [
                {
                    ...
                    "url": "https://t.me/sl_corona_update_bot?startgroup=new"
                }, 
                {
                    "text": "🔊 Group",
...
def staa():
    ...
    textt = str(
                    ...
                    '~ https://t.me/SL_MEDIA_TECH_GRUOP ~')
    return textt
